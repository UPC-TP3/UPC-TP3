            ...
            using (var cn = new SqlConnection(Configuraciones.CadenaConexion))
            {
                using (var cmd = new SqlCommand())
                {
                    ...
                    var parametrosSql = new[]
                    {
                        ...
                        new SqlParameter("@idcama", SqlDbType.Int) { Value = atencionmedica.idCama, Direction = ParameterDirection.Input }
                    };
        ...
        public List<ListadoAtencionBE> Listar(int id, string dni)
        {
            ...
            using (var cn = new SqlConnection(Configuraciones.CadenaConexion))
            {
                using (var cmd = new SqlCommand())
                {
                    ...
                    {
                        var colid = reader.GetOrdinal("ID_ATENCION");
                        ...
                        var colidCama = reader.GetOrdinal("IdCama");
                        ...
                        while (reader.Read())
                        {
                            lstatenciones.Add(new ListadoAtencionBE
                            {
                                ...
                                idCama = reader.GetValueInt32(colidCama)
                            });
                        }
