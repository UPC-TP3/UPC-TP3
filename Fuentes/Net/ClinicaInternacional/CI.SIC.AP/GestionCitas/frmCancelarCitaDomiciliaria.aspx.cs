...
public partial class GestionCitas_frmCancelarCitaDomiciliaria : System.Web.UI.Page
{
    ...
    protected void grvCita_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "Cancelar")
            {
                ...
                new BCitaDomiciliaria().Eliminar(codigoCita);
                Cargar();
            }
        }
        catch (Exception ex)
    ...
    private void Cargar()
    {
        grvCita.DataSource = new BCitaDomiciliaria().Listar();
        grvCita.DataBind();
    }
