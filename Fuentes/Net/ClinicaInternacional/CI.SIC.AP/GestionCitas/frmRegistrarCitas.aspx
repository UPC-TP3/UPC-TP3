                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset style="height: 120px;">
                                ...
                                <input type="button" id="btnBuscarMedico" value="Buscar Medico" 
                                    onclick="return btnBuscarMedico_onclick()" />
                                <table class="formulario">
                                    <colgroup>
                                        <col style="width: 20%;" />
                                        <col style="width: 5%; text-align: center;" />
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Button runat="server" ID="btnConfirmar" Text="Grabar Cita" CssClass="button"
                                OnClick="btnConfirmar_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="ReprogramarCitas.aspx" class="button">Regresar al Listado</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
