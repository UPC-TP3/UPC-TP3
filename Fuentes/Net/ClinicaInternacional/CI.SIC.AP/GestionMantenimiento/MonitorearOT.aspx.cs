...
public partial class GestionMantenimiento_MonitorearOT : System.Web.UI.Page
{
    ...
    protected void gvSolicitudes_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (obj != null)
            {
                var image = e.Row.FindControl("imgIndicador") as Image;
                if (image != null)
                {
                    if (obj.GM_Estado == "1")
                        image.ImageUrl = "~/Imagenes/Trafficlight_red.png";
                    else if (obj.GM_Estado == "2")
                        image.ImageUrl = "~/Imagenes/Trafficlight_yellow.png";
                    else if (obj.GM_Estado == "3")
                        image.ImageUrl = "~/Imagenes/Trafficlight_green.png";
                }
            }
        }
    }
