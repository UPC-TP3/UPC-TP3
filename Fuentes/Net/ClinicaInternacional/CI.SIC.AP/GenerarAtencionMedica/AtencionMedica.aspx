    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td>
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/GenerarAtencionMedica/Paciente.aspx">Nuevo Paciente</asp:HyperLink>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <td colspan="3">
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/GenerarAtencionMedica/Listado.aspx">Inicio</asp:HyperLink>
        </td>
    </table>
</asp:Content>
