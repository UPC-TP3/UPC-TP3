            ...
            <tr>
                <td colspan="3">
                    <asp:Label ID="lblMensaje" runat="server" Text=" "></asp:Label>
                        ...
                        <tr>
                <td colspan="3">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/GenerarAtencionMedica/AtencionMedica.aspx">Nuevo Ingreso</asp:HyperLink>
                </td>
            </tr>
        </table>
    </div>
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:ImageButton ID="ImageButton1" runat="server" AlternateText="Ver" ImageUrl="~/Imagenes/delete.png"
