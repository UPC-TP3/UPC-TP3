...
public class Constantes
{
    ...
    static public string CodTablaTipoDOC = ConfigurationManager.AppSettings["CodTabTipDoc"].ToString();
    static public string CodTablaSexo = ConfigurationManager.AppSettings["CodTabSexo"].ToString();
    static public string CodTablaProcedencia = ConfigurationManager.AppSettings["CodTabProcedencia"].ToString();
    static public string CodTablaTipoOrden = ConfigurationManager.AppSettings["CodTabTipoOrden"].ToString();
