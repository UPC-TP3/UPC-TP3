<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="Ver.aspx.cs" Inherits="EvaluacionDeInstalacionVer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlInstalacion" runat="server" AutoPostBack="True" >
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
