<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ordenPago.aspx.cs" Inherits="GestionImagenes_ordenPago" %>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <asp:Button ID="btnOrden_pago" runat="server" 
                                Text="Generar Orden Pago" onclick="btnOrden_pago_Click" Visible="False" />
                                    </td>
                                    <td>
