...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TB_Detalle_Solicitud_Mantenimiento]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TB_DETALLE_FICHA_EQUIPO]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TB_DET_ORDEN_TRABAJO]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING OFF
GO
CREATE TABLE [dbo].[TB_DET_ORDEN_TRABAJO](
	[GM_DetNroOrden] [int] IDENTITY(1,1) NOT NULL,
	[GM_NroOrden] [int] NULL,
	[GM_Fecha_Modificacion] [char](8) NULL,
	[GM_CodigoSolicitante] [char](8) NULL,
	[GM_Empleados_Asociados] [varchar](200) NULL,
	[GM_Prioridad] [varchar](50) NULL,
	[GM_Estado] [char](8) NULL,
	[GM_Motivo_Estado] [varchar](100) NULL,
...
CREATE TABLE [dbo].[TB_TURNO](
	...
	[Des_Turno] [varchar](255) NULL,
	[Horario_Turno] [varchar](255) NULL,
PRIMARY KEY CLUSTERED 
(
	[ID_TURNO] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TB_INFORME_DET]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[TB_CAMA](
	...
	[Estado] [varchar](255) NOT NULL,
	[ID_Hoja_Ingreso_Hospitalizacion] [int] NULL,
	[ID_Especialidad] [int] NULL,
...
SET ANSI_PADDING OFF
GO
/****** Object:  ForeignKey [FK__TB_AGENDA__ID_TU__2EDAF651]    ******/
ALTER TABLE [dbo].[TB_AGENDA_MEDICA]  WITH CHECK ADD FOREIGN KEY([ID_TURNO])
REFERENCES [dbo].[TB_TURNO] ([ID_TURNO])
GO
...
GO
/****** Object:  ForeignKey [FK_TB_CAMA_TB_ESPECIALIDAD]    ******/
ALTER TABLE [dbo].[TB_CAMA]  WITH CHECK ADD  CONSTRAINT [FK_TB_CAMA_TB_ESPECIALIDAD] FOREIGN KEY([ID_Especialidad])
REFERENCES [dbo].[TB_ESPECIALIDAD] ([ID_Especialidad])
GO
ALTER TABLE [dbo].[TB_CAMA] CHECK CONSTRAINT [FK_TB_CAMA_TB_ESPECIALIDAD]
GO
...
GO
/****** Object:  ForeignKey [FK__TB_INFORM__ID_In__5CA1C101]    ******/
...
GO
/****** Object:  ForeignKey [FK__TB_ORDEN___ID_Or__719CDDE7]    ******/
